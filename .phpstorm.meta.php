...
expectedArguments(\HillValley\Fluxcap\DateTime::formatIntl(), 1, argumentsSet('intl_format'));
expectedArguments(\HillValley\Fluxcap\DateTime::formatIntlDate(), 0, argumentsSet('intl_format'));
expectedArguments(\HillValley\Fluxcap\DateTime::formatIntlTime(), 0, argumentsSet('intl_format'));
expectedArguments(\HillValley\Fluxcap\Time::formatIntl(), 0, argumentsSet('intl_format'));

registerArgumentsSet('time_zones',
    'Africa/Abidjan',
    'Africa/Accra',
    'Africa/Addis_Ababa',
    'Africa/Algiers',
...
expectedArguments(\HillValley\Fluxcap\TimeZone::fromString(), 0, argumentsSet('time_zones'));
